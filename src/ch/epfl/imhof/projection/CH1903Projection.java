...
public final class CH1903Projection implements Projection {
    ...
    public Point project(PointGeo point) {
        ...
        double powLon = pow(longitude, 2), powLat = pow(latitude, 2);

        x = 600_072.37 + (211_455.93 * longitude)
                - (10_938.51 * longitude * latitude)
                - (0.36 * longitude * powLat) - (44.54 * pow(longitude, 3));
        y = 200_147.07 + (308_807.95 * latitude) + (3_745.25 * powLon)
                + (76.63 * powLat) - (194.56 * powLon * latitude)
    ...
    public PointGeo inverse(Point point) {
        ...
        double powX = pow(x, 2), powY = pow(y, 2);

        longitude = 2.677_909_4 + (4.728_982 * x) + (0.791_484 * x * y)
                + (0.130_6 * x * powY) - (0.043_6 * pow(x, 3));
        latitude = 16.902_389_2 + (3.238_272 * y) - (0.270_978 * powX)
                - (0.002_528 * powY) - (0.044_7 * powX * y)
                - (0.014_0 * pow(y, 3));
