...
//            }
    ...
    public static void main(String[] args) throws IOException, SAXException {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            map3 = new OSMToGeoTransformer(new CH1903Projection()).transform(OSMMapReader.readOSMFile("data/lausanne.osm.gz", true));
            tEnd = System.currentTimeMillis();
            tDelta = tEnd - tStart;
            System.out.println(tDelta / 1000.0);
            moyenne += tDelta / 1000.0;
        }
